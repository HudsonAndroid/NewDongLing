...
public class LyricsAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    protected int mFocusColor = RecyclerLyricsView.DEFAULT_FOCUS_LYRICS_COLOR;
    protected int mNormalColor = RecyclerLyricsView.DEFAULT_NORMAL_LYRICS_COLOR;
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == TYPE_TOP){//headerView
            ...
            return new LyricsViewHolder(item,mFocusColor,mNormalColor);
        }
    }
