...
public class LyricsViewConfig {
    ...
    public LyricsViewConfig setTypeface(Typeface typeface) {
        this.typeface = typeface;
        return this;
    }

    public LyricsViewConfig setTextSize(float textSize) {
    ...
    public ILyricsView getEmptyLyricsView(Context activityContext){
        ...
        emptyLyricsView.setFocusLyricsColor(focusColor);
        emptyLyricsView.setLyricsTextSize(textSize);
        emptyLyricsView.setLyricsTypeface(typeface);
